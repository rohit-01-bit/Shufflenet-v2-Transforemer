We are attaching three datasets links in dataset link option. THree interactive python notebooks where the model is trained, tested, and result analysis is done.
